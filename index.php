...
// Content
$mail->isHTML(true);                       
$mail->Subject = 'Confirmation of your MK comic subscription';
$mail->Body    = 'Thankyou For Subscribing to: <b>MK Comics!!</b><br>Welcome to world full of superheroes.';
$mail->AltBody = 'Thankyou For Subscribing to: Marvel Comics! Welcome to world full of superheroes.';
